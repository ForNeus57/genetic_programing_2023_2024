...
/**
 * This class does not serve any useful application apart from testing if I did not screw up during refactor of TinyGP
 * <p>
 * It is used in tests as a way to check if the output is the same on both ends.
 * </p>
 * <p>
 * Yes it is modified a bit, but nothing much.
 * </p>
 */
